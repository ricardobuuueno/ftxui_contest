...
// configuration step. It creates a namespace called `ftxui_contest`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        ftxui_contest::cmake::project_name,
        ftxui_contest::cmake::project_version));// version string, acquired
